...
puts "begin ipa-build:\n need_clean : #{need_clean}\n workspace_name : #{workspace_name}\n configuration : #{configuration}\n target_name : #{target_name}\n scheme : #{scheme}\n ipa_name : #{ipa_name}\n exportFullPath : #{export_ipa_path}".green
...
if !target_name
  puts 'Please ensure input -t <target_name> command'.red
  exit
end

if !scheme
  puts 'Please ensure input -s <scheme_name> command'.red
  exit
end
...
puts "project_path : #{project_path}".green
puts "build_path : #{build_path}".green
puts "compiled_path : #{compiled_path}".green
...
app_info_plist_path = "#{compiled_path}/#{target_name}.app/Info.plist"
